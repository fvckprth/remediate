...
const ANIM_STEPS: AnimStep[] = [
  ...
  /* 35 */ { state: "annotatePopover", cursorX: "299px", cursorY: "calc(100% - 179px)", click: false, duration: 300, itemCount: 1, typedChars: 13, scrollY: 0, priority: "none" },
  /* 36 */ { state: "annotatePopover", cursorX: "299px", cursorY: "calc(100% - 179px)", click: true,  duration: 250, itemCount: 1, typedChars: 13, scrollY: 0, priority: "low" },
  /* 37 */ { state: "annotatePopover", cursorX: "299px", cursorY: "calc(100% - 179px)", click: true,  duration: 250, itemCount: 1, typedChars: 13, scrollY: 0, priority: "medium" },
  /* 38 */ { state: "annotatePopover", cursorX: "299px", cursorY: "calc(100% - 179px)", click: true,  duration: 250, itemCount: 1, typedChars: 13, scrollY: 0, priority: "high" },
  /* 39 */ { state: "annotatePopover", cursorX: "299px", cursorY: "calc(100% - 179px)", click: true,  duration: 250, itemCount: 1, typedChars: 13, scrollY: 0, priority: "urgent" },
  /* 40 */ { state: "annotatePopover", cursorX: "299px", cursorY: "calc(100% - 179px)", click: true,  duration: 350, itemCount: 1, typedChars: 13, scrollY: 0, priority: "high" },
  /* 41 */ { state: "annotatePopover", cursorX: "calc(100% - 299px)", cursorY: "calc(100% - 134px)", click: false, duration: 400, itemCount: 1, typedChars: 13, scrollY: 0, priority: "high" },
  /* 42 */ { state: "annotatePopover", cursorX: "calc(100% - 299px)", cursorY: "calc(100% - 134px)", click: true,  duration: 250, itemCount: 1, typedChars: 13, scrollY: 0, priority: "high" },
