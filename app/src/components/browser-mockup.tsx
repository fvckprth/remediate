...
const ANIM_STEPS: AnimStep[] = [
  ...
  /* 30 */ { state: "annotateHover",  cursorX: "272px", cursorY: "121px", click: false, duration: 500, itemCount: 1, scrollY: 0 },
  /* 31 */ { state: "annotateHover",  cursorX: "272px", cursorY: "121px", click: true,  duration: 250, itemCount: 1, scrollY: 0 },
  ...
  /* 35 */ { state: "annotatePopover", cursorX: "299px", cursorY: "245px", click: false, duration: 300, itemCount: 1, typedChars: 13, scrollY: 0, priority: "none" },
  /* 36 */ { state: "annotatePopover", cursorX: "299px", cursorY: "245px", click: true,  duration: 250, itemCount: 1, typedChars: 13, scrollY: 0, priority: "low" },
  /* 37 */ { state: "annotatePopover", cursorX: "299px", cursorY: "245px", click: true,  duration: 250, itemCount: 1, typedChars: 13, scrollY: 0, priority: "medium" },
  /* 38 */ { state: "annotatePopover", cursorX: "299px", cursorY: "245px", click: true,  duration: 250, itemCount: 1, typedChars: 13, scrollY: 0, priority: "high" },
  /* 39 */ { state: "annotatePopover", cursorX: "299px", cursorY: "245px", click: true,  duration: 250, itemCount: 1, typedChars: 13, scrollY: 0, priority: "urgent" },
  /* 40 */ { state: "annotatePopover", cursorX: "299px", cursorY: "245px", click: true,  duration: 350, itemCount: 1, typedChars: 13, scrollY: 0, priority: "high" },
  /* 41 */ { state: "annotatePopover", cursorX: "495px", cursorY: "288px", click: false, duration: 400, itemCount: 1, typedChars: 13, scrollY: 0, priority: "high" },
  /* 42 */ { state: "annotatePopover", cursorX: "495px", cursorY: "288px", click: true,  duration: 250, itemCount: 1, typedChars: 13, scrollY: 0, priority: "high" },
