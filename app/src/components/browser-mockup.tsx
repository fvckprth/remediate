...
const ANIM_STEPS: AnimStep[] = [
  ...
  /* 15 */ { state: "capturePanel",   cursorX: "calc(100% - 160px)", cursorY: "calc(100% - 182px)", click: false, duration: 300, typedChars: 7, scrollY: 0 },
  /* 16 */ { state: "capturePanel",   cursorX: "calc(100% - 160px)", cursorY: "calc(100% - 182px)", click: false, duration: 250, typedChars: 14, scrollY: 0 },
  /* 17 */ { state: "capturePanel",   cursorX: "calc(100% - 160px)", cursorY: "calc(100% - 182px)", click: false, duration: 400, typedChars: 20, scrollY: 0 },
  ...
  /* 19 */ { state: "capturePanel",   cursorX: "calc(100% - 259px)", cursorY: "calc(100% - 140px)", click: true,  duration: 250, typedChars: 20, scrollY: 0, priority: "low" },
  /* 20 */ { state: "capturePanel",   cursorX: "calc(100% - 259px)", cursorY: "calc(100% - 140px)", click: true,  duration: 350, typedChars: 20, scrollY: 0, priority: "urgent" },
  /* 21 */ { state: "capturePanel",   cursorX: "calc(100% - 60px)", cursorY: "calc(100% - 98px)", click: false, duration: 400, typedChars: 20, scrollY: 0, priority: "urgent" },
  /* 22 */ { state: "capturePanel",   cursorX: "calc(100% - 60px)", cursorY: "calc(100% - 98px)", click: true,  duration: 200, typedChars: 20, scrollY: 0, priority: "urgent" },
  ...
  /* 24 */ { state: "countOnly",      cursorX: "calc(100% - 40px)", cursorY: "calc(100% - 40px)", click: false, duration: 500, itemCount: 1, scrollY: 0 },
  /* 25 */ { state: "countOnly",      cursorX: "calc(100% - 40px)", cursorY: "calc(100% - 40px)", click: true,  duration: 250, itemCount: 1, scrollY: 0 },
  ...
  /* 30 */ { state: "annotateHover",  cursorX: "calc(50% - 124px)", cursorY: "121px", click: false, duration: 500, itemCount: 1, scrollY: 0 },
  /* 31 */ { state: "annotateHover",  cursorX: "calc(50% - 124px)", cursorY: "121px", click: true,  duration: 250, itemCount: 1, scrollY: 0 },
  /* 32 */ { state: "annotatePopover", cursorX: "50%", cursorY: "180px", click: false, duration: 600, itemCount: 1, typedChars: 0, scrollY: 0 },
  /* 33 */ { state: "annotatePopover", cursorX: "calc(50% + 0px)", cursorY: "203px", click: false, duration: 350, itemCount: 1, typedChars: 5, scrollY: 0 },
  /* 34 */ { state: "annotatePopover", cursorX: "calc(50% + 0px)", cursorY: "203px", click: false, duration: 350, itemCount: 1, typedChars: 13, scrollY: 0 },
  /* 35 */ { state: "annotatePopover", cursorX: "calc(50% - 97px)", cursorY: "245px", click: false, duration: 300, itemCount: 1, typedChars: 13, scrollY: 0, priority: "none" },
  /* 36 */ { state: "annotatePopover", cursorX: "calc(50% - 97px)", cursorY: "245px", click: true,  duration: 250, itemCount: 1, typedChars: 13, scrollY: 0, priority: "low" },
  /* 37 */ { state: "annotatePopover", cursorX: "calc(50% - 97px)", cursorY: "245px", click: true,  duration: 250, itemCount: 1, typedChars: 13, scrollY: 0, priority: "medium" },
  /* 38 */ { state: "annotatePopover", cursorX: "calc(50% - 97px)", cursorY: "245px", click: true,  duration: 250, itemCount: 1, typedChars: 13, scrollY: 0, priority: "high" },
  /* 39 */ { state: "annotatePopover", cursorX: "calc(50% - 97px)", cursorY: "245px", click: true,  duration: 250, itemCount: 1, typedChars: 13, scrollY: 0, priority: "urgent" },
  /* 40 */ { state: "annotatePopover", cursorX: "calc(50% - 97px)", cursorY: "245px", click: true,  duration: 350, itemCount: 1, typedChars: 13, scrollY: 0, priority: "high" },
  /* 41 */ { state: "annotatePopover", cursorX: "calc(50% + 98px)", cursorY: "288px", click: false, duration: 400, itemCount: 1, typedChars: 13, scrollY: 0, priority: "high" },
  /* 42 */ { state: "annotatePopover", cursorX: "calc(50% + 98px)", cursorY: "288px", click: true,  duration: 250, itemCount: 1, typedChars: 13, scrollY: 0, priority: "high" },

  // ── ACT 3: Text note (steps 43-61) ──
  /* 43 */ { state: "countOnly",      cursorX: "calc(100% - 40px)", cursorY: "calc(100% - 40px)", click: false, duration: 500, itemCount: 2, scrollY: 0 },
  /* 44 */ { state: "countOnly",      cursorX: "calc(100% - 40px)", cursorY: "calc(100% - 40px)", click: true,  duration: 250, itemCount: 2, scrollY: 0 },
  ...
  /* 52 */ { state: "textPanel",      cursorX: "calc(100% - 160px)", cursorY: "calc(100% - 182px)", click: false, duration: 300, itemCount: 2, typedChars: 7, scrollY: 0 },
  /* 53 */ { state: "textPanel",      cursorX: "calc(100% - 160px)", cursorY: "calc(100% - 182px)", click: false, duration: 350, itemCount: 2, typedChars: 16, scrollY: 0 },
  /* 54 */ { state: "textPanel",      cursorX: "calc(100% - 160px)", cursorY: "calc(100% - 182px)", click: false, duration: 300, itemCount: 2, typedChars: 24, scrollY: 0 },
  /* 55 */ { state: "textPanel",      cursorX: "calc(100% - 160px)", cursorY: "calc(100% - 182px)", click: false, duration: 350, itemCount: 2, typedChars: 31, scrollY: 0 },
  ...
  /* 57 */ { state: "textPanel",      cursorX: "calc(100% - 257px)", cursorY: "calc(100% - 140px)", click: true,  duration: 250, itemCount: 2, typedChars: 31, scrollY: 0, priority: "low" },
  /* 58 */ { state: "textPanel",      cursorX: "calc(100% - 257px)", cursorY: "calc(100% - 140px)", click: true,  duration: 350, itemCount: 2, typedChars: 31, scrollY: 0, priority: "medium" },
  /* 59 */ { state: "textPanel",      cursorX: "calc(100% - 62px)", cursorY: "calc(100% - 98px)", click: false, duration: 400, itemCount: 2, typedChars: 31, scrollY: 0, priority: "medium" },
  /* 60 */ { state: "textPanel",      cursorX: "calc(100% - 62px)", cursorY: "calc(100% - 98px)", click: true,  duration: 200, itemCount: 2, typedChars: 31, scrollY: 0, priority: "medium" },
  ...
  /* 62 */ { state: "countOnly",      cursorX: "calc(100% - 40px)", cursorY: "calc(100% - 40px)", click: false, duration: 500, itemCount: 3, scrollY: 0 },
  /* 63 */ { state: "countOnly",      cursorX: "calc(100% - 40px)", cursorY: "calc(100% - 40px)", click: true,  duration: 250, itemCount: 3, scrollY: 0 },
  ...
  /* 75 */ { state: "voicePreview",   cursorX: "calc(100% - 58px)", cursorY: "calc(100% - 96px)", click: false, duration: 350, itemCount: 3, scrollY: 260 },
  /* 76 */ { state: "voicePreview",   cursorX: "calc(100% - 58px)", cursorY: "calc(100% - 96px)", click: true,  duration: 200, itemCount: 3, scrollY: 260 },
  ...
  /* 78 */ { state: "countOnly",      cursorX: "calc(100% - 40px)", cursorY: "calc(100% - 40px)", click: false, duration: 500, itemCount: 4, scrollY: 0 },
  /* 79 */ { state: "countOnly",      cursorX: "calc(100% - 40px)", cursorY: "calc(100% - 40px)", click: true,  duration: 250, itemCount: 4, scrollY: 0 },
  ...
  /* 84 */ { state: "reviewing",      cursorX: "calc(100% - 66px)", cursorY: "calc(100% - 96px)", click: false, duration: 350, itemCount: 4, scrollY: 0 },
  /* 85 */ { state: "reviewing",      cursorX: "calc(100% - 66px)", cursorY: "calc(100% - 96px)", click: true,  duration: 200, itemCount: 4, scrollY: 0 },
];
    ...
    <div className="absolute bottom-5 right-5 z-10">
      ...
      <div
        ...
        style={{
          ...
          padding: 4,
          height: 40,
          width: isCountOnly ? (itemCount > 9 ? 48 : 40) : isSuccess ? 48 : isIdle ? 90 : showSendBadge ? 240 : 162,
          fontFamily: FONT,
