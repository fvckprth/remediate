  ...
  return (
    <div className="flex flex-col shrink-0 h-full">
      ...
      <div className="flex-1 flex flex-col justify-center">
        <nav aria-label="Documentation" className="flex flex-col text-base font-medium tracking-tight leading-none">
      ...
      <div className="flex items-center gap-2 h-4 text-foreground/50">
        <a
        ...
        <a
          href="https://open.spotify.com/playlist/36RXHjMBMN3vHkm6KQO2O0?si=578ff2bb91c44924"
          target="_blank"
          rel="noopener noreferrer"
          className="transition-colors hover:text-foreground/70"
        >
